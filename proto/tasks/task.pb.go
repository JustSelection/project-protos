...
func (x *ListTasksByUserResponse) Reset() {
	*x = ListTasksByUserResponse{}
	mi := &file_proto_tasks_task_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListTasksByUserResponse) Descriptor() ([]byte, []int) {
	return file_proto_tasks_task_proto_rawDescGZIP(), []int{12}
}
...
var file_proto_tasks_task_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_proto_tasks_task_proto_goTypes = []any{
	...
	(*ListTasksByUserRequest)(nil),  // 11: task.ListTasksByUserRequest
	(*ListTasksByUserResponse)(nil), // 12: task.ListTasksByUserResponse
}
var file_proto_tasks_task_proto_depIdxs = []int32{
	...
	11, // 9: task.TaskService.ListTasksByUser:input_type -> task.ListTasksByUserRequest
	...
	12, // 14: task.TaskService.ListTasksByUser:output_type -> task.ListTasksByUserResponse
